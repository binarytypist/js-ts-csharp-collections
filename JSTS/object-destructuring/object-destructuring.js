// Object destructuring practice in JavaScript

const user = { name: 'Ava', age: 28, city: 'Berlin' };
const { name, age } = user;
...
const employee = { role: 'developer', active: true };
const details = { name: 'Lina', age: 30 };
