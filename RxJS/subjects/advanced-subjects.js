...
const { BehaviorSubject, ReplaySubject, AsyncSubject, Subject } = require('rxjs');
...
const messageHistory = new ReplaySubject(2);
...
const clickEvents = new ReplaySubject(3);
...
const apiResults = new ReplaySubject(100, 5000);
...
const downloadProgress = new AsyncSubject();
...
const httpRequest = new AsyncSubject();
...
setTimeout(() => {
    httpRequest.next({ status: 200, data: 'User found', name: 'John' });
...
const authEvents = new ReplaySubject(10); // Keep last 10 events
